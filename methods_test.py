...
init_habit('Петь', 'Пить воду 2 раза в неделю важно для поддержания водного баланса')
init_habit('Пробежка в парке', 'Пробежка 2 раза в неделю важна для поддержания работы сердца')
assign_habit(1111111111, habit_id('Пробежка в парке'), 'еженедельно', 3)
assign_habit(1111111111, habit_id('Петь'), 'ежемесячно', 5)
...
mark_habit(1111111111, habit_id('Пробежка в парке'), '2024-03-17', 1)
...
mark_habit(1111111111, habit_id('Петь'), '2024-03-15', 2)
